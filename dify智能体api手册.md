...
POST
/chat-messages
curl -X POST 'http://192.168.1.3/v1/chat-messages' \
...
POST
/files/upload
curl -X POST 'http://192.168.1.3/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
GET
/end-users/:end_user_id
curl -X GET 'http://192.168.1.3/v1/end-users/6ad1ab0a-73ff-4ac1-b9e4-cdb312f71f13' \
--header 'Authorization: Bearer {api_key}'
...
GET
/files/:file_id/preview
curl -X GET 'http://192.168.1.3/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview' \
--header 'Authorization: Bearer {api_key}'
...
curl -X GET 'http://192.168.1.3/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview?as_attachment=true' \
--header 'Authorization: Bearer {api_key}' \
...
POST
/chat-messages/:task_id/stop
curl -X POST 'http://192.168.1.3/v1/chat-messages/:task_id/stop' \
...
POST
/messages/:message_id/feedbacks
curl -X POST 'http://192.168.1.3/v1/messages/:message_id/feedbacks \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "rating": "like",
...
GET
/app/feedbacks
curl -X GET 'http://192.168.1.3/v1/app/feedbacks?page=1&limit=20'
...
GET
/messages/{message_id}/suggested
curl --location --request GET 'http://192.168.1.3/v1/messages/{message_id}/suggested?user=abc-123 \
...
GET
/messages
curl -X GET 'http://192.168.1.3/v1/messages?user=abc-123&conversation_id=' \
--header 'Authorization: Bearer {api_key}'
...
GET
/conversations
curl -X GET 'http://192.168.1.3/v1/conversations?user=abc-123&last_id=&limit=20'\
--header 'Authorization: Bearer {api_key}'
...
DELETE
/conversations/:conversation_id
curl -X DELETE 'http://192.168.1.3/v1/conversations/:conversation_id' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "user": "abc-123"
...
POST
/conversations/:conversation_id/name
curl -X POST 'http://192.168.1.3/v1/conversations/:conversation_id/name' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "name": "",
...
GET
/conversations/:conversation_id/variables
curl -X GET 'http://192.168.1.3/v1/conversations/{conversation_id}/variables?user=abc-123' \
--header 'Authorization: Bearer {api_key}'
...
PUT
/conversations/:conversation_id/variables/:variable_id
curl -X PUT 'http://192.168.1.3/v1/conversations/{conversation_id}/variables/{variable_id}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "value": "Updated Value",
...
POST
/audio-to-text
curl -X POST 'http://192.168.1.3/v1/audio-to-text' \
--header 'Authorization: Bearer {api_key}' \
...
POST
/text-to-audio
curl --location --request POST 'http://192.168.1.3/v1/text-to-audio' \
--header 'Authorization: Bearer ENTER-YOUR-SECRET-KEY' \
...
GET
/info
curl -X GET 'http://192.168.1.3/v1/info' \
-H 'Authorization: Bearer {api_key}'
...
GET
/parameters
 curl -X GET 'http://192.168.1.3/v1/parameters'\
--header 'Authorization: Bearer {api_key}'
...
POST
/meta
curl -X GET 'http://192.168.1.3/v1/meta' \
-H 'Authorization: Bearer {api_key}'
...
GET
/site
curl -X GET 'http://192.168.1.3/v1/site' \
-H 'Authorization: Bearer {api_key}'
